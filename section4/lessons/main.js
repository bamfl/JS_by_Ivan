<div id='test'>
	<div class="box__row">
        ...
        function prevArrow(el) {
          ...
          el.nextSibling.style.transform = `translate(0, -${el.parentElement.parentElement.offsetHeight * countScroll}px)`;
        }

        function nextArrow(el) {
          let height = 0;
          if (
            el.parentElement.parentElement.offsetHeight * (countScroll + 1) + el.parentElement.parentElement.offsetHeight >
            el.previousSibling.previousSibling.offsetHeight
          ) {
            if (el.parentElement.parentElement.offsetHeight < el.previousSibling.previousSibling.offsetHeight) {
              height = -el.previousSibling.previousSibling.offsetHeight + el.parentElement.parentElement.offsetHeight;
            }
          } else {
            height = -el.parentElement.parentElement.offsetHeight * (countScroll + 1);
            countScroll++;
          }
