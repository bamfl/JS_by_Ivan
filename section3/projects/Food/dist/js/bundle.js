...
function card() {
  ...
  clearParent(); // const getData = async (url) => {
...
function counter() {
  const daysBox = document.getElementById('days'),
        ...
        secondsBox = document.getElementById('seconds'); // Counter
...
function form() {
  ...
  const bindPostData = form => {
    form.addEventListener('submit', event => {
      ...
      const formData = new FormData(form); // const jsonObject = {};
      ...
      postData('http://localhost:3000/requests', 'POST', jsonData).then(jsonData => {
...
/* harmony export */   "modalWindow": function() { return /* binding */ modalWindow; },
/* harmony export */   "closeActions": function() { return /* binding */ closeActions; }
/* harmony export */ });
...
function tabs() {
  const tabContent = document.querySelectorAll('.tabcontent'),
        ...
        tabList = document.querySelector('.tabheader__items'); // Tabs
